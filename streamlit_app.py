...
def update_weather():
    ...
    weather.markdown(f'<div id="weather">{temp}°C<i class="big-icon wi wi-wmo4680-{weathercode}"></i><i class="wi wi-wmo4680-{weathercode}" style="font-size: 48px;"></i></div>', unsafe_allow_html=True)
