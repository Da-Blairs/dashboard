...
with col1:
    ...
    st.markdown(f'<div id="food"><span class="count">Dinner Today</span><br><span>Sushi Bowls</span><br><br><span class="count">Dinner Tomorrow</span><br><span>Pork Chops & Fries</span></div>' , unsafe_allow_html= True)
...
def updateDinner():    
    ...
    service = build('calendar', 'v3', credentials=creds)
    dinnerId = 'primary' #
    events_result = service.events().list(calendarId='d784fd49eb9057cf7c36c7d91c36b40613c3a86da4e351020ae0d1eaa4568cc2@group.calendar.google.com', timeMin=midnight_toronto_iso(),
