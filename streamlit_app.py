...
with col1:
    ...
    if(books_read):
        st.markdown(f'<div id="steps"><span><span class="count">{books_read}</span>&nbsp;summer reads</span><span class="count">&nbsp;</span><i class="fa-solid fa-book"></i></div>' , unsafe_allow_html= True)
